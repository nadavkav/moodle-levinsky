...
?>
    <div id="sitename">
        <h1><?php echo format_string($SITE->shortname, true, array('context' => context_course::instance(SITEID))) ?></h1>
    </div>
...
if (in_array('saml', $authsequence)){
    if (isset($saml_config->samllogoimage) && $saml_config->samllogoimage != NULL) {
        echo '<a href="' . $samlUrl . '"><img src="'.$saml_config->samllogoimage.'" border="0" alt="SAML login" class="img-fluid"></a>';
    }
