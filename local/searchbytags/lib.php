...
class local_searchbytags_question_bank_search_condition extends core_question\bank\search\condition {
    ...
    public function display_options_adv() {
        ...
        echo html_writer::label('תצוגת שאלות בעלות התגיות:', 'tags[]');
        echo "<br />\n";
        echo html_writer::select($tags, 'tags[]', $this->tags, array('' => '--תצוגת כל השאלות--'), $attr);
        echo "<br />\n";
        echo html_writer::label('תצוגת שאלות ללא התגיות:', 'tags[]');
        echo "<br />\n";
        echo html_writer::select($tags, 'nottags[]', $this->nottags, array('' => '--תצוגת כל השאלות--'), $attr);
        echo "<br />\n";
    }
