...
/**
 * Search area for mod_streamitup activities.
 *
...
namespace mod_streamitup\search;
...
class activity extends \core_search\base_activity {
    ...
    /**
     * Overwritten as streamitups are displayed in-course.
     *
     * @param \core_search\document $doc
     * @return \moodle_url
     */
    public function get_doc_url(\core_search\document $doc) {
        // Get correct URL to section that contains streamitup, from course format.
        ...
        // Add the ID of the streamitup to the section URL.
        $url->set_anchor('module-' . $cminfo->id);
        return $url;
    }

    /**
     * Overwritten as streamitups are displayed in-course. Link to the course.
     *
     * @param \core_search\document $doc
     * @return \moodle_url
     */
